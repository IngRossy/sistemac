...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">INGRESO DE FABRICAS </h1>
    ...
    <form name="form1" method="post" action="guardar fabrica.php">
      <table width="945" border="1" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr>
          <td width="183"><div align="right">Nombre de fabrica </div></td>
          ...
          <td width="140"><div align="right">Tel&eacute;fono</div></td>
        ...
        <tr>
          <td colspan="7"><div align="center">
              <label>
              <input name="btnguardad" type="submit" id="btnguardad" value="Guardar Fabrica">
              </label>
            </div>
              <div align="left"></div>
            <div align="left"></div>
        ...
        <tr>
          <td colspan="7"><div align="left">
            ...
            <table width="902" border="1" align="center" cellpadding="1" cellspacing="1">
                <tr>
                  <td width="229" bgcolor="#B5B7F9"><div align="left"><strong>Nombre de fabrica </strong></div></td>
                  <td width="125" bgcolor="#B5B7F9"><div align="left"><strong>Tel&eacute;fono</strong></div></td>
		...
		$consultax2 = mysql_query("SELECT * FROM fabrica ORDER BY nombre",$coneccion) or dir ("error en la conexion");
		$extraidox1 = mysql_fetch_assoc($consultax2);
		do{ ?>
                <tr>
                  <td><div align="left"><?php echo $extraidox1['nombre']; ?> </div></td>
                  <td><div align="left"><?php echo $extraidox1['telefono']; ?></div></td>
                  <td bgcolor="#F2D5C8"><div align="left" ><a href="eliminar fabrica.php?cod=<?php echo $extraidox1['idfabrica']; ?>">Eliminar</a></div></td>
                </tr>
                <tr>
                  <td colspan="3"><hr></td>
                </tr>
