...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">PEDIDOS REALIZADOS </h1>
    ...
    <table width="706" border="1" align="center" cellpadding="1" cellspacing="1">
      ...
      <?php 
		...
		$consultax2 = mysql_query("SELECT * FROM pedido ORDER BY fecha",$coneccion) or dir ("error en la conexion");
